...
public class Coffee {
    ...
    public void  refill (double amount){
        System.out.println("Refiling $"+amount+" worth coffee");
        System.out.println("After refill my total coast is $"+(price+amount));
    }
//    public void totalCost(double price){
//        price+=price;//Java prioritizes the local variables over instance variables when they have same name
//    }
}
